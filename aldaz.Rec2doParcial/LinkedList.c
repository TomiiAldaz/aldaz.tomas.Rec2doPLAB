...
int ll_remove(LinkedList* this, int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        ...
        }else
        {
            ...
            pPrevNode->pNextNode = auxNode->pNextNode;
        }
...
int ll_push(LinkedList* this, int index, void* pElement)
{
    ...
    if(this != NULL && index >= 0 && index <= ll_len(this)) //Podria no estar pq ya lo hace addNode
    {
    ...
    if(this != NULL && pFunc != NULL)
    {
        ...
        if( filterList != NULL)
        {
            ...
            for(int i=0; i < tam ; i++)
            {
                ...
                if(pFunc(aux))
                {
                    if(ll_add(filterList, aux)) // Si falla
                    {
    ...
    if(this != NULL && pFunc != NULL)
    {
        ...
        if( mapList != NULL)
        {
            ...
            for(int i=0; i < tam ; i++)
            {
                ...
                if(pFunc(aux))
                {
                    if(ll_add(mapList, aux)) // Si falla
                    {
